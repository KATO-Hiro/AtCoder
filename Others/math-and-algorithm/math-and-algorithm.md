...
- n % 4 == 0のときだけ、後手が勝つ
- 上記以外のときは先手が(ry
  - n % 4 == 0のケースにも持ち込めるが、そのときの手番でわざわざ負ける手を選ぶことはないことを気がつけなかった

http://ooya-takemasa.thick.jp/Suuraku/FutayamaKuzushi.pdf
...
整数、最小化、長方形、面積、周の長さ、約数

- 面積が決まっているので、辺の長さの候補を全て列挙
  - 面積の約数を取る
- 辺の長さ = 2種類の辺の長さの和 * 2
- 上記の最小値を取る
